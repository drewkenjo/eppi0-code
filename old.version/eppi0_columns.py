def define_eppi0_columns_using_proton(df):
    vals = 'pe,the,fie,pp,thp,fip,pg1,thg1,fig1,pg2,thg2,fig2,mm2,mgg,yy,q2,ww,xb,tt,phistar,ftheta,misse,dpx,dpy,dpz,dphi,dtheta,mmp'

    rdf = df.Define("vals","""
    double E0 = 10.6041;
    double Mpro = 0.938272;
