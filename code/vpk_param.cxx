...
// dvmpx(tt, xb, Q2, phi, ee);
double dvmpx(double mt, double xb, double Q2, double phistar , double E, int heli=0) {
   double PHI_G = phistar*TMath::DegToRad();

   const Double_t EBeam = 10.6041;
